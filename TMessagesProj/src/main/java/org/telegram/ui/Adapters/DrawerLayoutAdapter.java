...
public class DrawerLayoutAdapter extends BaseAdapter {
    ...
    private int reportSpam = 13;
    private int cachContolerRow = 14;

    private int themingRow = 16;
    private int themeStoreRow = 17;
    private int offlineThemesRow = 18;
    private int settingsRow = 19;
    private int plusSettingsRow = 20;
    private int channelRow = 22;
    private int InviteFriends = 23;
    private int Allmedia = 24;
    private int AboutUs = 25;
    private int faqRow = 26;
    private int versionRow = 27;
